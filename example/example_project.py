...
K_INVEST[10] = K_INVEST[0] * 0.05  # K_INVEST[t] is an additional investment happening at year t+1
...
operating_cashflow, operating_cashflow_std, non_operating_cashflow, non_operating_cashflow_std = p_example.get_cashflows(
    WACC)
...
DEPRECIATION_PERIOD = STORE_RESULTS["ATTR"]["DEPRECIATION_PERIOD"]
INVEST_TEMP = STORE_RESULTS["ATTR"]["K_INVEST"].mean()
if DEPRECIATION_PERIOD > LIFETIME_TEMP:
    RATIO_OPEN_PRINCIPAL = 1 - (LIFETIME_TEMP / DEPRECIATION_PERIOD)
